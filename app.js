...
window.addEventListener("scroll", ()=>{
    ...
    saluteTextContainer.style.transform = `translateY(${scrolly * 0.9}px)`;
    saluteImgContainer.style.transform = `translate(${scrolly * 0.4}px, ${scrolly * 0.7}px)`;
    authorName.style.transform = `translateX(${scrolly * 0.2}px)`;
    jobTitleContainer[0].style.backgroundPositionY = `${scrolly * 0.5}px`;
    jobTitleContainer[1].style.backgroundPositionY = `${-scrolly * 0.5}px`;

    jobTitle[0].style.transform = `translateX(${200 - (scrolly / window.innerHeight * 100)}vh)`;
    jobTitle[1].style.transform = `translateX(${-300 + (scrolly / window.innerHeight * 100)}vh)`;
    projectTitle.style.transform = `translateX(${400 - (scrolly / window.innerHeight * 100)}vh)`;
    phone[0].style.transform = `translateX(${500 - (scrolly / window.innerHeight * 100)}vh)`;
    //phone[1].style.transform = `translateX(${750 - (scrolly / window.innerHeight * 100)}vh)`;
    laptop.style.transform = `translateX(${590 - (scrolly / window.innerHeight * 100)}vh)`;
